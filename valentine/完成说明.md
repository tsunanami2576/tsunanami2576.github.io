...
# 复制valentine项目到仓库
# ⚠️ 重要：不要在valentine目录中使用git init！
cp -r /home/lmz/Learning/HTML/valentine ./valentine

# 如果valentine目录中有.git文件夹，删除它
/bin/rm -rf valentine/.git
...
如果没有，创建新仓库：
```bash
# 1. 在GitHub网站上创建新仓库: 你的用户名.github.io
